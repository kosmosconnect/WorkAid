/* =====================================================================
   WORKAID — icon sprite.
   Loaded WITHOUT defer immediately after <body> so every <symbol> exists
   before the page's <use> elements are parsed. Keeping the sprite here
   rather than pasted into each page means one file to edit, and it still
   works when the site is opened straight off disk (file://), which an
   external .svg sprite would not.
   Usage:  <svg class="ico"><use href="#i-name"></use></svg>
   ===================================================================== */
(function () {
  "use strict";
  ...
  var i = {
    ...
    "clipboard": '<path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/><path d="M9 14h6M9 17h4"/>',
    ...
    /* Sectors */
    "building": '<path d="M3 21h18M5 21V4a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v17M15 9h3a1 1 0 0 1 1 1v11"/><path d="M8 7h2M8 11h2M8 15h2"/>',
    "factory": '<path d="M3 21h18M4 21V10l6 3.5V10l6 3.5V6l4-2v17"/><path d="M7 17h.01M12 17h.01M17 17h.01"/>',
  ...
  for (var key in i) {
    if (Object.prototype.hasOwnProperty.call(i, key)) {
      out += '<symbol id="i-' + key + '" viewBox="0 0 24 24">' + i[key] + "</symbol>";
    }
  }
  out += "</svg>";
